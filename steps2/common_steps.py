...
#
#
# @when('User Enter "{test_data}" on "{locator_value}" using "{locator_type}" on "{page_name}" Page')
...
#
#
# @when('User Assert "{test_data}" on "{locator_value}" using "{locator_type}" on "{page_name}" Page')
