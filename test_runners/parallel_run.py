...
#
#     # Setup directories
#     temporary_environment_file, temporary_steps_dir = SetupDirectories.setup_directories(base_dir, util_factory_dir,
#                                                                                          steps_dir)
#
...
#     parallel = FileReaders.get_yaml_property(environment_file_path, "parallel")
#     if parallel is None:
